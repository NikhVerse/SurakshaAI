...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      {/* Header & Logo */}
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* Row 1: First, Middle, Last Name (3 Columns) */}
              ...
              {/* Row 2: Age, DOB, Gender (3 Columns) */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-700">
                  ...
                  <input
                    ...
                    className={`h-11 w-full rounded-xl border bg-slate-50/50 px-3.5 text-sm sm:text-base font-medium text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white transition-all ${
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 text-sm sm:text-base font-medium text-slate-900 focus:outline-none focus:border-slate-900 focus:bg-white focus:ring-2 focus:ring-slate-900/10 transition-all"
                  />
                </div>
                  ...
                  <div className="h-11 grid grid-cols-3 gap-1 p-1 rounded-xl bg-slate-100 border border-slate-200">
                    {(["M", "F", "Other"] as const).map((g) => (
                      <button
                        ...
                        type="button"
                        onClick={() => setGender(g)}
                        className={`h-full rounded-lg text-sm font-bold transition-all cursor-pointer flex items-center justify-center ${
                          gender === g
